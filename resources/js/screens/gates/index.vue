...
<template>
    <index-screen title="Gates" resource="gates">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <router-link :to="{name:'gate-preview', params:{id: slotProps.entry.id}, query: {service: getCurrentService(), file_path: slotProps.entry.file_path}}" class="control-action">
