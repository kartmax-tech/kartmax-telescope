...
<template>
    <index-screen title="Mail" resource="mail">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <router-link :to="{name:'mail-preview', params:{id: slotProps.entry.id}, query: {service: getCurrentService(), file_path: slotProps.entry.file_path}}" class="control-action">
