...
<template>
    <index-screen title="Events" resource="events">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <router-link :to="{name:'event-preview', params:{id: slotProps.entry.id}, query: {service: getCurrentService(), file_path: slotProps.entry.file_path}}" class="control-action">
