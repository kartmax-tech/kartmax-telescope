...
<template>
    <index-screen title="Jobs" resource="jobs" show-all-family="true">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <router-link :to="{name:'job-preview', params:{id: slotProps.entry.id}, query: {service: getCurrentService(), created_at: slotProps.entry.created_at, hostname: slotProps.entry.content.hostname, name: slotProps.entry.content.name, connection: slotProps.entry.content.connection, queue: slotProps.entry.content.queue, status: slotProps.entry.content.status, file_path: slotProps.entry.file_path}}" class="control-action">
