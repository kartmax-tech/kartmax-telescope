...
<template>
    <index-screen title="Requests" resource="requests">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <router-link :to="{name:'request-preview', params:{id: slotProps.entry.id}, query: {service: getCurrentService(), created_at: slotProps.entry.created_at, hostname: slotProps.entry.content.hostname, method: slotProps.entry.content.method, uri: slotProps.entry.content.uri, status: slotProps.entry.content.response_status, file_path: slotProps.entry.file_path}}" class="control-action">
