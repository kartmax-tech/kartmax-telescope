...
<template>
    <index-screen title="Exceptions" resource="exceptions">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <router-link :to="{name:'exception-preview', params:{id: slotProps.entry.id}, query: {service: getCurrentService(), file_path: slotProps.entry.file_path}}" class="control-action">
