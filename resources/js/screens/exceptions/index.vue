...
<template>
    <index-screen title="Exceptions" resource="exceptions">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <router-link :to="{name:'exception-preview', params:{id: slotProps.entry.id}, query: {service: getCurrentService(), created_at: slotProps.entry.created_at, hostname: slotProps.entry.content.hostname, class: slotProps.entry.content.class, message: slotProps.entry.content.message}}" class="control-action">
